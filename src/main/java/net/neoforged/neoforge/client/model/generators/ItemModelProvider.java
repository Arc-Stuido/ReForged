...
/**
 * Stub: NeoForge ItemModelProvider — data provider for item models.
 */
public abstract class ItemModelProvider extends ModelProvider<ItemModelBuilder> {
    ...
    public ItemModelBuilder simpleBlockItem(ResourceLocation block) {
        return withExistingParent(block.toString(),
                ResourceLocation.fromNamespaceAndPath(block.getNamespace(), "block/" + block.getPath()));
    }
