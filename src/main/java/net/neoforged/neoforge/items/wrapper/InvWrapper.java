...
/**
 * Proxy: NeoForge's InvWrapper — wraps a vanilla Container as IItemHandlerModifiable.
 */
public class InvWrapper implements IItemHandlerModifiable {
    ...
    @Override
    public int getSlots() { return getInv().getContainerSize(); }

    @Override
    public ItemStack getStackInSlot(int slot) { return getInv().getItem(slot); }
    ...
    @Override
    public int getSlotLimit(int slot) { return getInv().getMaxStackSize(); }
    ...
    @Override
    public int hashCode() { return getInv().hashCode(); }
}
