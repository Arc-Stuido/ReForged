...
public class BossHealthOverlay {
    ...
    public static final ResourceLocation[] OVERLAY_BACKGROUND_SPRITES = new ResourceLocation[]{
    ...
    public static final ResourceLocation[] OVERLAY_PROGRESS_SPRITES = new ResourceLocation[]{
