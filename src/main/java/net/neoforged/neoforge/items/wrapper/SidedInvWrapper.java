...
/**
 * Proxy: NeoForge's SidedInvWrapper — wraps a WorldlyContainer as IItemHandlerModifiable.
 */
public class SidedInvWrapper implements IItemHandlerModifiable {
    ...
    @Override
    public int getSlots() {
        if (side == null) return inv.getContainerSize();
    ...
    @Override
    public int getSlotLimit(int slot) { return slotLimit.applyAsInt(slot); }
